...
.section1 > h1 {color: #333; font-size: 30px;}
...
.section1 form span{margin-right: 20px;}

.section1 input[type="password"],
.section1 input[type="text"],
.section1 input[type="email"],
.section1 input[type="submit"],
.section1 input[type="reset"]{width: 230px; margin-bottom: 20px; height: 30px;
border: 1px solid #f19292; border-radius: 5px;}

.section1 input[type="submit"],
.section1 input[type="reset"]{background-color: #fff; color: #333; transition: 0.3s;
margin-left:80px;}
...
.section1  ul {}
.section1 ul > li{}
.section1 ul > li:nth-child(2){margin-left:35px;}
.section1 ul > li:nth-child(3){margin-left:14px;}
...
<body>
  ...
  <section class="section section1">
    ...
    <ul>
      <li> <span>비밀번호</span>  <input type="password" name="pw" required></li>
      <li> <span>이름</span><input type="text" name="name" value="${userdata.name}" required></li>
      <li>	<span>이메일</span> <input type="email" name="email" value="${userdata.email}"></li>
