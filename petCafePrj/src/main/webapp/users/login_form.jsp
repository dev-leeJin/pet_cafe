  ...
  <!-- ?§Îçî -->
    <header class="header">
      ...
      <form action="http://loaclhost:8181/petCafePrj/loginCheck"  class="form-group form-inline" method="post">
         <input type="text" class="form-control" name="id" placeholder="?ÑÏù¥??>
         <input type="password" class="form-control" name="pw" placeholder="ÎπÑÎ?Î≤àÌò∏">
        <input type="submit" class="btn btn-outline-primary" value="Î°úÍ∑∏??>
    ...
    <ul class="menu">
      <li class="menu-li"><a href="#">?†Í≤¨ÏΩòÌÖå?§Ìä∏</a></li>
      <li class="menu-li"><a href="#">?†Í≤¨ Î∂ÑÏñë</a></li>
      <li class="menu-li"><a href="#">?†Í∏∞Í≤¨Í≤å?úÌåê</a></li>
      <li class="menu-li"><a href="#">?êÏú†Í≤åÏãú??/a></li>
    </ul>
    </header>
    ...
    <div class="content">
      ...
      <div class="today_Box">
        ...
        <div class="join_Box">
          <form>
            <input type="submit" value="?åÏõêÍ∞Ä?ÖÌïòÍ∏? class="join_Button">
          </form>
        </div>
    </div>
        ...
        <body>
          ...
          <div class="col-lg-2">
           <input type="text" class="form-control" name="id" placeholder="?ÑÏù¥??><br/>
           <input type="password" class="form-control" name="pw" placeholder="ÎπÑÎ?Î≤àÌò∏"><br/>	
          </div>
          <div class="cel-lg-1">
          <input type="submit" class="btn btn-outline-primary" value="Î°úÍ∑∏??>
          <input type="submit" class="btn btn-outline-primary" value="?åÏõêÍ∞Ä??>
          </div>
          </form>
        </body>
...
<!-- ?∏ÌÑ∞ -->
    ...
    <div class="contaier">
      <address>
             ...
             ?úÏö∏?πÎ≥Ñ??ÎßàÌè¨Íµ??ëÌôîÎ°?Ï≤®Îã®ÎπåÎî© 7Ï∏?br>
            ?∞ÎùΩÏ≤?: 02-0202-0202<br>
                COPYRIGHT &copy; ICT?∏Ïû¨Í∞úÎ∞ú??All Rights Reserved
