...
.contents_Form input[type="password"],
.contents_Form input[type="submit"]{width: 230px;}

.contents_Form input[type="submit"]:nth-child(1){margin-bottom: 20px;}
.contents_Form input[type="text"],
.contents_Form input[type="password"]{border: 1px solid #f19292;}
