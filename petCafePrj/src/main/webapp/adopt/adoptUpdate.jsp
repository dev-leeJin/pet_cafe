...
<section class="section section1">
  <form action="http://localhost:8181/petCafePrj/adoptUpdate.do" method="post">
    ...
    <li>품종 <input type="text" name="kind" value="${adopt.adopt_kind}"></li>
    <li>이름 <input type="text" name="name" value="${adopt.adopt_name}"></li>
    <li>나이 <input type="text" name="age" value="${adopt.adopt_name}"></li>
    <li>성별 <input type="checkbox" name="gender" value="${adopt.adopt_name}"></li>
