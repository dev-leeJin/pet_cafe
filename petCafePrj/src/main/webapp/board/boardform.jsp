 <%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <%response.sendRedirect("http://localhot:8181/MyFirstWeb/boardList.do");%>
   </c:if>
<!DOCTYPE html>
<html>
<head>
...
.section1 textarea{width:400px; padding: 5px;
margin-bottom:10px;
border-radius: 5px;
border: 1px solid #f19292;
color: #333;
outline: none;}
.section1 input[type="submit"]{width: 160px;
padding: 5px;
...
<form action="http://localhost:8181/petCafePrj/boardInsert.do" method="post">
  ...
  <textarea rows="30" cols="50" name="content" placeholder="내용" required></textarea> <br />
